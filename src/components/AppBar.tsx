      ...
      <div className="navbar flex flex-row md:mb-2 shadow-lg bg-neutral text-neutral-content">
          ...
          <label htmlFor="my-drawer" className="btn btn-square btn-ghost">
            ...
            <svg className="inline-block w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" >
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16"></path>
                  ...
                  <div>
                      <a href="\">
                      <img src={"UGCgreen.png"} />        {/* UGC LOGO APP BAR*/}
          </a>
                          </div>
        </div>
        ...
        <div className="hidden md:inline md:navbar-center">
          <div className="flex items-stretch">
            <Link href="/#present">
              <a className="btn btn-ghost btn-sm rounded-btn">UGC</a>
            </Link>
            <Link href="/basics">
              <a className="btn btn-ghost btn-sm rounded-btn">Staking</a>
                      ...
                      <Link href="/team">
                          <a className="btn btn-ghost btn-sm rounded-btn">The Team</a>
                      </Link>

                      <Link href="/rarity">
                          <a className="btn btn-ghost btn-sm rounded-btn">Rarity</a>
                      </Link>
                      <Link href="/underconstruction">
                          <a className="btn btn-ghost btn-sm rounded-btn">$UGCT</a>
                      </Link>
        ...
        <div className="navbar-end">
          <div className="dropdown">
              ...
              <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="green">
